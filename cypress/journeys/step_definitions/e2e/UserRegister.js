...
When('el usuario ingresa el nombre y el email', function () {
   cy.get('input[data-qa="signup-name"]').type('Tomas Rios');
   cy.get('input[data-qa="signup-email"]').type('tom-9@gmail.com');
...
When('el usuario verifica que el nombre este precargado', function () {
   cy.get('input[id="name"]').should('have.value', 'Tomas Rios');
});
When('el usuario verifica que el email esta precargado', function () {
   cy.get('input[id="email"]').should('have.value', 'tom-9@gmail.com');
});
